...
<div class="container">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4>Allergies</h4>
            <div class="">
            <a class="btn btn-sm btn-primary mr-3" href="{{route('admin.medications.create')}}">Add Medicatons</a>
            <a class="btn btn-sm btn-primary" href="{{route('admin.allergies.create')}}">Add Allergy</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
