...
<div class="container page-container">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-sm btn-primary" href="{{route('admin.medications.show',$medication->allergy->user->id)}}">Back</a>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            @endif
            <form action="{{route('admin.medications.update',$medication->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
